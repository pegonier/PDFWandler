...
112        */
               ...
               /*
117        * All the code above created a listening server, which waits for
118        * connections to come in and then handles any messages that arrive at
...
159        */
               ...
               MainController.logfile.put(LocalDateTime.now().toString(), response);
